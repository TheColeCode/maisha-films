...
export default function Card({title, category, releaseDate, about, watchNow, trailer, poster, links}) {
  return (
    <li
      ...
      <div style={{'display': 'grid', 'grid-template-columns': '200px auto'}}>
        ...
        <div>
          ...
          <div className="flex mb-2">
            <a href={watchNow} title="Watch Now | Finding Hope Home" target="_blank" rel="noreferrer" className="font-bold" style={{'color': 'white'}}>Watch Now</a>
