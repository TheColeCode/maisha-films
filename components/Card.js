...
export default function Card({title, releaseDate, about, trailer, poster, links}) {
  return (
    <li
    ...
    >
      <div style={{'display': 'grid', 'grid-template-columns': '200px auto'}}>
        ...
        <div>
          <h3 className="uppercase mb-3 font-bold">{title}</h3>
          <p className="uppercase mb-3 font-bold opacity-60">Release Date: {releaseDate}</p>
          <div className="flex">
